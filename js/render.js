...
(function (global) {
  ...
  function renderSettings(model, container, o) {
    ...
    sectionHeading(
      ...
      "lightbulb",
      "追加候補のサジェスト",
      "警告が残っているとき、追加すると警告が減る人を鍵ビューに提案します。月の実働がこの時間以上の人だけが候補になります(学生IS除外用)。"
    );
  ...
  var HELP_SECTIONS = [
    ...
    },
    {
      title: "「人数の確認」の見方",
      lines: [
        "カレンダーの各日に、超早(流通便など)・開=開け番・中=中番・閉=閉め番の人数が表示されます。",
    ...
    },
    {
      ...
      lines: [
        ...
        "追加候補のサジェスト: 「候補」ボタンの対象になる最低実働時間です(学生ISや勤務時間の少ないPNを候補に表示されないようにするため)。",
      ],
    },
    {
      title: "困ったら",
